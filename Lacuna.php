...
<html lang="en">
	...
	<body>
		<div id="topbar">
			...
			<div id="buttons">
				<div id="cameracontrols" title="Camera Interaction Controls" ><img src="imgs/cameracontrols.png"></img></div>
				<div id="cameracontrolsoptions">
					<div id="trackball" title="Trackball Controls"><img id="trackballimage" src="imgs/trackball.png" ></img></div>
					<div id="fly" title="Fly Controls"><img id="flyimage" src="imgs/fly.png" ></img></div>
					<div id="roll" title="Roll Controls"><img id="rollimage" src="imgs/roll.png" ></img></div>
					<div id="firstperson" title="First Person Controls"><img id="firstpersonimage" src="imgs/firstperson.png" ></img></div>
					<div id="orbit" title="Orbit Controls"><img id="orbitimage" src="imgs/orbit.png" ></img></div>
					<div id="path" title="Path Controls"><img id="pathimage" src="imgs/path.png" ></img></div>
				</div>
				<div id="camera" title="Camera Options" ><img src="imgs/camera.png"></img></div>
				...
				<div id="mode" title="Pointer Mode"> Visualise </div>
			</div>
		</div>
		...
		<script src="js/setupEvents.js"></script>
...
<script src="typeface-0.15.js"></script>
		...
		<!-- lacuna.js is the file that runs the page loading code not found on this page, and calls the init() method -->
